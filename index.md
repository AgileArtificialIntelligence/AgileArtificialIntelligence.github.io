...
_Agile Artificial Intelligence_ is a book that covers classical algorithms commonly assimilated as artificial intelligence techniques. The book series takes a practical approach by presenting implementation details for the Pharo programming language. 

# Book outline

_The book content is removed from public eye according to the contract specified with Apress, the publisher of the book._
...
1. Artificial Neuron
1. Neural Network
1. Theory on Learning
1. Data Classification
1. A Matrix Library
1. Matrix-Based Neural Network
1. Using Keras from Pharo

Part II: Genetic Algorithm
1. Genetic Algorithm
1. Genetic Algorithm in Action
1. Traveling salesman problem
1. Robot looking for an exit
1. Building Zoomorphic creature
...
A tremendous effort has been put in this book. Although we put a maximum of dedication, there are always things that could be improved. Your feedback is essential to improve the book content. By providing feedback, you will:
